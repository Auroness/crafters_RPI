...
#define ACCOUNT_BETA			( 1 << 9 )		//accepted Beta accounts

	//Staff Emeritus - normal account, with wiznet permissions only
#define ACCOUNT_EMERITUS		( 1 << 10 )		
...
/* Modification Members */
	...
	bool toggle_beta() {
		flags = flags ^ ACCOUNT_BETA;
        save_flags();
		return flags & ACCOUNT_BETA;
	}
	
	bool toggle_emeritus() {
		flags = flags ^ ACCOUNT_EMERITUS;
        save_flags();
		return flags & ACCOUNT_EMERITUS;
	}
